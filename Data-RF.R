...
set.seed(456)
mod.rf <- randomForest(DELAYED ~ .-FL_DATE - ORIGIN_CITY_NAME - ORIGIN_STATE_NM - DEST_CITY_NAME - DEST_STATE_NM - CRS_DEP_TIME - CRS_ARR_TIME - ARR_DELAY - NAME.x - NAME.y - MONTH, data = class.train)
